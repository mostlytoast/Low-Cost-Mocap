...
pip install numpy scipy flask Flask-SocketIO Ruckig flask-cors scikit-spatial line-profiler PyQt5 opencv-python-headless imutils pyvirtualcam pyinstaller
