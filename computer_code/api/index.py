...
# ser = serial.Serial("/dev/cu.usbserial-02X2K2GE", 1000000, write_timeout=1, ) //TODO have config option for running without drone 
...
def camera_stream():
    ...
    # cameras.set_ser(ser) //TODO have config option for running without drone 
